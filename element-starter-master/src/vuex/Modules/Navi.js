...
const actions = {
    ...
    //存入场次类型数据
    changePublishTypeListAction({commit}, payload) {
        commit('changePublishTypeListMutation', payload)
    }
}
...
const mutations = {
    ...
    changePublishTypeListMutation (state, payload) {
        state.publishTypeList = payload
    }
}
